    ...
    <div className='shadow-sm'>
        <div className='relative group'>
            ...
            <div className='absolute right-3 bottom-3 flexCenter gap-x-2'>
                <Link to={`/product/${product._id}`} className='bg-white h-8 w-8 p-2 rounded-full show-inner cursor-pointer transition-all duration-500 opacity-0 group-hover:opacity-100'>
                ...
                {!cartItems[product._id] ? (
                    ...
                    <div className='bg-white rounded-full flexCenter gap-2 h-8'>
                        <FaMinus onClick={()=> removeFromCart(product._id)} className='rounded-full h-6 w-6 p-1 ml-1 bg-primary cursor-pointer'/>
        ...
        <div className='p-3'>
            <div className='flexBetween'>
                <h5 className='text-[16px] front-bold text-gray-900/50'>{product.category}</h5>
